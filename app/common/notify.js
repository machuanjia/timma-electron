(function (global, factory) {
    ...
    function Notify(title) {
        ...
        var rest = _objectWithoutProperties(options, ['icon', 'notifyShow', 'notifyClose', 'notifyClick', 'notifyError', 'closeOnClick', 'timeout']);
    ...
    exportsNotify['default'] = Notify;

    Object.defineProperty(exportsNotify, '__esModule', {value: true});
